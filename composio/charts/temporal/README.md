...
![Version: 0.68.1](https://img.shields.io/badge/Version-0.68.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.29.0](https://img.shields.io/badge/AppVersion-1.29.0-informational?style=flat-square)
...
| admintools.image.tag | string | `"1.29"` |  |
| admintools.livenessProbe.enabled | bool | `false` |  |
...
| admintools.readinessProbe.enabled | bool | `false` |  |
...
| server.frontend.livenessProbe.enabled | bool | `false` |  |
...
| server.frontend.readinessProbe.enabled | bool | `false` |  |
...
| server.history.livenessProbe.enabled | bool | `false` |  |
...
| server.history.readinessProbe.enabled | bool | `false` |  |
...
| server.image.tag | string | `"1.29.0"` |  |
...
| server.matching.livenessProbe.enabled | bool | `false` |  |
...
| server.matching.readinessProbe.enabled | bool | `false` |  |
...
| server.worker.livenessProbe.enabled | bool | `false` |  |
...
| server.worker.readinessProbe.enabled | bool | `false` |  |
